...
class RepulsiveAvoidanceNode(Node):
    def __init__(self):
        ...
        self.default_targets = [(0, 0.5), (1, 0.5)]
    ...
    def swap_targets(self):
        """Swap the target positions of agent 1 and agent 2."""
        if self.num_agents < 2:
            return
        ...
        self.get_logger().info(
            f"🔁 Swapped targets: agent 1 -> (x={tx1:.3f}, y={ty1:.3f}), "
            f"agent 2 -> (x={tx2:.3f}, y={ty2:.3f})"
        )
